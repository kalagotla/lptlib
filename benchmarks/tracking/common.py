...
# lptlib treats mpi4py as an optional dependency and imports it defensively, so
# nothing here needs to stand one in. An earlier version of this file installed
# a stub module, which stopped working once lptlib.io.dataio began configuring
# mpi4py.rc before importing MPI.
