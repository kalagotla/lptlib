...
class TestStreamlines(unittest.TestCase):
    def test_streamlines(self):
        ...
        sl = Streamlines(grid_file='../../data/plate_data/plate.sp.x', flow_file='../../data/plate_data/sol-0000010.q',
    ...
    def test_streamlines_mb(self):
        ...
        sl = Streamlines(grid_file='../../data/multi_block/plate/plate.mb.sp.x',
                         flow_file='../../data/multi_block/plate/plate.mb.sp.q', point=[0.5, 0.5, 0.01], time_step=1)
        sl.compute()
