        ...
        match method:
            ...
            case 'p-space':
                ...
                if self.idx.cell.shape == (8, 3) and self.idx.info is None:
                    ...
                    # Parametric tri-linear interpolation using computational-space
                    ...
                    if self.idx.cpoint is not None:
                        ...
                        # Fall back to sequential physical-space interpolation
                        # when cpoint is not available (e.g., block_distance search)
